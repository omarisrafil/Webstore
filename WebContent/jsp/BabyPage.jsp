...
<body>
	...
	<div>
	<h4 align="center">BEBEK ÜRÜNLERİ ...</h4>
	<% request.setCharacterEncoding("UTF-8");
	String sqlkod = "SELECT U.urunID, upper(K.ad), T.ad, U.beden, U.fiyat FROM Urun U, Kategori K, Tur T WHERE U.kategoriID = K.kategoriID and U.turID = T.turID and U.kategoriID = 4 ORDER BY urunID DESC";
